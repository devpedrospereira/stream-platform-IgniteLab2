                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold">
                            Aula 01 - Criando o projeto e realizando o setup
                            inicial
                        </h1>
                        <p className="mt-4 text-gray-200 leading-relaxed">
                            ...
                            nosso projeto no GraphCMS criando as entidades da
                            aplicação e integrando a API GraphQL gerada pela
                        ...
                        <div className='flex items-center gap-4 mt-6 flex items-center'>
                            <img 
                                ...
                                src="https://github.com/devpedrospereira.png" 
                                alt="avatar GitHub" 
                            />

                        <a href="https://github.com/devpedrospereira" >
                            <div className='leading-relaxed'>
                                <strong className='font-bold text-2xl block'>Pedro S. Pereira</strong>
                                <span className='text-gray-200 text-sm block'>Estudante @Rocketseat</span>
